...
class TestDishNutrientsEndpoint:
    ...
    def test_get_dish_nutrients_success(
        ...
        response = order_client.get(f"{API_PREFIX}/dishes/{test_dish.id}/nutrients")
    ...
    def test_get_dish_nutrients_not_found(self, order_client: TestClient):
        ...
        response = order_client.get(f"{API_PREFIX}/dishes/999999/nutrients")
    ...
    def test_get_dish_nutrients_without_ingredients(
        ...
        response = order_client.get(f"{API_PREFIX}/dishes/{dish.id}/nutrients")
        assert response.status_code == 200
...
class TestOrderNutrientsEndpoint:
    ...
    def test_get_order_nutrients_success(
        ...
        response = order_client.get(f"{API_PREFIX}/nutrients/orders/{order_id}/nutrients")
    ...
    def test_get_order_nutrients_not_found(self, order_client: TestClient):
        ...
        response = order_client.get(f"{API_PREFIX}/nutrients/orders/999999/nutrients")
        assert response.status_code == 404
...
class TestUserNutrientsEndpoint:
    ...
    def test_get_user_nutrients_success(
        ...
        response = order_client.get(f"{API_PREFIX}/nutrients/users/{user_id}/nutrients")
    ...
    def test_get_user_nutrients_no_orders(self, order_client: TestClient):
        ...
        response = order_client.get(f"{API_PREFIX}/nutrients/users/999999/nutrients")
...
class TestMenuEndpoint:
    ...
    def test_get_menu_success(
        ...
        response = order_client.get(f"{API_PREFIX}/dishes/menu/")
...
class TestCreateOrderEndpoint:
    ...
    def test_create_order_success(
        ...
        response = order_client.post(f"{API_PREFIX}/orders/", json=order_data)
...
class TestGetUserOrdersEndpoint:
    ...
    def test_get_user_orders_success(
        ...
        user_id = test_order_with_items["order"].user_id
        response = order_client.get(f"{API_PREFIX}/orders/{user_id}")
    ...
    def test_get_user_orders_no_orders(self, order_client: TestClient):
        ...
        response = order_client.get(f"{API_PREFIX}/orders/999999")
...
class TestGetAllDishesEndpoint:
    ...
    def test_get_all_dishes_success(
        ...
        response = order_client.get(f"{API_PREFIX}/dishes/")
